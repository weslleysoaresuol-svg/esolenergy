...
const MOCK_DOCUMENTS: GovernanceDocument[] = [
  {
    id: "doc-1",
    titulo: "SOP-01: Manual de Engenharia & Comissionamento EPC V15.0",
    categoria: "sop",
    tamanho: "4.2 MB",
    versao: "v15.0/2026",
    atualizadoEm: "02/08/2026",
    descricao: "Procedimentos operacionais padrão para montagem de usinas fotovoltaicas e comissionamento com margem piso 20%.",
    tags: ["Engenharia", "SOP", "Tier-1", "V15.0"],
  },
  {
    id: "doc-2",
    titulo: "Contrato Modelo de Parceria Comercial & MMN V15.0",
    categoria: "contratos",
    tamanho: "2.1 MB",
    versao: "v15.0/2026",
    atualizadoEm: "02/08/2026",
    descricao: "Minuta contratual padronizada com cláusulas Cash-Basis, Quarentena 180d, Carência 30d, Anti-Stacking e Margem Piso 20%.",
    tags: ["Jurídico", "Cash-Basis", "MMN", "V15.0"],
  },
  {
    id: "doc-3",
    titulo: "Compêndio Regulatório ANEEL REN 1.000/2021 & Lei 14.300 V15.0",
    categoria: "aneel",
    tamanho: "8.5 MB",
    versao: "v15.0/2026",
    atualizadoEm: "02/08/2026",
    descricao: "Compilado de regras sobre o Fio B progressivo, direitos de parecer de acesso GD e Mercado Livre.",
    tags: ["ANEEL", "Fio B", "Regulatório", "V15.0"],
  },
  {
    id: "doc-4",
    titulo: "Relatório de Auditoria SOC 2 Type II & Ledger SHA-256 V15.0",
    categoria: "soc2",
    tamanho: "3.5 MB",
    versao: "v15.0/2026",
    atualizadoEm: "02/08/2026",
    descricao: "Certificado de segurança cibernética, conciliação BaaS, escrituração contábil SHA-256 e auditoria criptográfica.",
    tags: ["Segurança", "SOC 2", "Ledger", "V15.0"],
  },
];
