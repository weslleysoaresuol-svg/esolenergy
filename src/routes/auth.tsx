  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-navy via-navy-deep to-navy flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8">
        ...
        <p className="text-sm text-center text-muted-foreground mb-6">Entre com sua conta ESOL Energy</p>
        ...
        <p className="text-xs text-muted-foreground text-center mt-6">
          Novo parceiro? Para criar sua conta você precisa de um <strong>link de convite</strong> enviado pelo administrador.
        </p>

        <Link to="/" className="block text-center text-sm text-muted-foreground mt-4 hover:text-navy">← Voltar ao site</Link>
      </div>
    </div>
  );
}
