...
*   **Perfis de Atuação e Remuneração:**
    *   **1. Construtor de Rede (Foco em Alavancagem e Renda Passiva):** Parceiro que foca em recrutar, capacitar e estruturar equipes comerciais, sendo recompensado através dos **Overrides da Rede MMN em até 7 Níveis**, gerando ganhos residuais passivos recorrentes sobre o faturamento do seu time.
    *   **2. Vendedor de Elite (Foco em Produção Direta):** Parceiro focado na prospecção direta de clientes. Ele é recompensado de forma agressiva com a comissão de venda direta padrão e com o **Bônus de Produtividade Direta**, um multiplicador financeiro extra pago exclusivamente sobre o seu volume pessoal de novos negócios fechados (quem mais vende, mais bônus de produtividade recebe; quem não vende nada pessoalmente, não recebe este bônus).
...
| **L2** | **Raiz** | 100 | 🌳 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L3** | **Rocha** | 300 | 🪨 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L4** | **Gota** | 600 | 💧 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L5** | **Nascente** | 1.000 | 🌊 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L6** | **Rio** | 1.500 | 🏞️ | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L7** | **Brisa** | 2.000 | 🍃 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L8** | **Vento** | 2.800 | 💨 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L9** | **Ciclone** | 3.800 | 🌀 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L10** | **Faísca** | 5.000 | ✨ | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L11** | **Chama** | 6.500 | 🔥 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L12** | **Fogueira** | 8.000 | 🪵 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L13** | **Lua** | 10.000 | 🌙 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L14** | **Terra** | 12.500 | 🌍 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L15** | **Sol** | 15.000 | ☀️ | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L16** | **Meteoro** | 18.000 | ☄️ | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L17** | **Cometa** | 22.000 | 🌠 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L18** | **Supernova** | 26.000 | 💥 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L19** | **Triunfo** | 30.000 | 🏆 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L20** | **Plenitude** | 40.000 | 💎 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
| **L21** | **Legado** | 50.000 | 👑 | **Bônus de Produtividade Direta:** Qualificação para bônus mensal com base em suas vendas diretas. Kit marca opcional debitado do saldo. |
