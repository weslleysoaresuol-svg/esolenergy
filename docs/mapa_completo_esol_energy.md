...
*   **L2 (Chama) $\rightarrow$** *Kit Escritório de Campo:* **Notebook Lenovo ou Acer** (Ryzen 5/SSD 512GB) + **Mochila Executiva Impermeável** com saída USB (valor total de R$ 2.350,00) para estruturar o backoffice móvel.
