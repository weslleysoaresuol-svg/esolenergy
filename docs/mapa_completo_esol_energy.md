...
*   **L2 (Chama) $\rightarrow$** *Mini Gerador Solar Portátil:* **Kit Sistema Solar de Emergência** (contendo mini painel solar fotovoltaico, bateria de lítio integrada com saídas USB para carga de celulares, lanterna de emergência e 3 lâmpadas LED independentes, valor de mercado de R$ 350,00) para demonstração prática a clientes ou uso doméstico.
*   **L3 (Raio) $\rightarrow$** *Kit Escritório de Campo:* **Notebook Lenovo ou Acer** (Ryzen 5/SSD 512GB) + **Mochila Executiva Impermeável** com saída USB (valor total de R$ 2.350,00) para estruturar o backoffice móvel.
