...
*   **L2 (Chama) $\rightarrow$** *Gerador Solar Portátil Off-Grid:* **Estação de Energia Portátil (Power Station 300W/500W)** com bateria de lítio integrada + **Painel Solar Dobrável** (valor de mercado de R$ 1.500,00) para demonstração de tecnologia em campo e mostruário de revenda.
