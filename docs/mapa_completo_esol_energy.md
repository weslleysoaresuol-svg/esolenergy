...
*   **L2 (Chama) $\rightarrow$** *Kit Escritório de Campo:* **Notebook Lenovo ou ASUS** (Ryzen 3 LPDDR5/SSD 256GB) + **Mochila Executiva Impermeável** com saída USB (valor total de R$ 1.750,00) para estruturar o backoffice móvel.
*   **L3 (Raio) $\rightarrow$** *Estação Fotovoltaica Off-Grid & Mapeamento:* **Estação de Energia Portátil (Power Station 300W/500W)** com bateria de lítio e painel solar dobrável + **Mini Drone com Câmera HD** para vídeos e mapeamento técnico de telhados (valor total do combo de R$ 2.400,00) para suporte completo de marketing e vendas.
*   **L4 (Lua) $\rightarrow$** *Tablet & Imersão VIP:* **iPad de 10.2 polegadas com caneta digital e capa** (para apresentação comercial) + Imersão VIP de 3 dias de Liderança na sede da Esol Energy com todas as despesas pagas (valor total de R$ 6.000,00).
*   **L5 (Terra) $\rightarrow$** *Mobilidade Limpa:* **Scooter Elétrica de Cidade 0km** (ex: Watts ou Voltz, valor de mercado de R$ 15.000,00 quitada), conectando a conquista ao propósito de energia limpa da holding.
*   **L6 (Órbita) $\rightarrow$** *Viagem VIP Internacional:* Viagem de 7 dias com acompanhante para a feira *Intersolar Europe em Munique, Alemanha* (passagens aéreas executivas e hotel 5 estrelas, valor total de R$ 25.000,00).
