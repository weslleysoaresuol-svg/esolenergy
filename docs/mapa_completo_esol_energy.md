...
*   **L5 (Terra) $\rightarrow$** *Mobilidade Limpa & Suporte de Escritório:* **Scooter Elétrica de Cidade 0km** (ex: Watts ou Voltz, valor de R$ 15.000,00 quitada e em seu nome) + **Suporte Financeiro Opcional para Montagem de Escritório/Showroom Local** (auxílio de custo de até R$ 9.500,00 sob consulta de disponibilidade orçamentária e aprovação de projeto pela diretoria da holding).
