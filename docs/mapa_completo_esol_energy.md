...
*   **L5 (Terra) $\rightarrow$** *Hub de Vendas (Escritório Regional):* **Verba de R$ 15.000,00 para Montagem e Fachada do Escritório/Showroom de Representação Esol** na cidade do parceiro, fornecendo infraestrutura física para receber clientes de grande porte.
