...
*   **Navbar Superior Clara (Header):** Usar [`esol-logo-horizontal.svg`](file:///d:/Projetos%20Lovable/Esol%20Energy/esolenergy/brand-kit/1. Web-SVG/esol-logo-horizontal.svg) (cor original, largura compacta que valoriza o nome).
*   **Navbar Superior Escura / Proposta V6:** Usar [`esol-logo-horizontal-negative.svg`](file:///d:/Projetos%20Lovable/Esol%20Energy/esolenergy/brand-kit/1. Web-SVG/esol-logo-horizontal-negative.svg) (letras brancas + sol dourado ativo).
*   **Favicon e Loader de Página:** Usar [`esol-logo-brandmark.svg`](file:///d:/Projetos%20Lovable/Esol%20Energy/esolenergy/brand-kit/1. Web-SVG/esol-logo-brandmark.svg).

#### B. Para Redes Sociais, Canva e Office:
*   **Foto de Perfil (Instagram, LinkedIn, WhatsApp):** Usar [`esol-logo-brandmark.png`](file:///d:/Projetos%20Lovable/Esol%20Energy/esolenergy/brand-kit/2. Imagens-PNG/esol-logo-brandmark.png) (sol centrado no tamanho ideal de avatar).
*   **Posts, Banners e Flyers Digitais:** Usar os arquivos da pasta [`2. Imagens-PNG/`](file:///d:/Projetos%20Lovable/Esol%20Energy/esolenergy/brand-kit/2. Imagens-PNG) conforme o contraste do fundo (colorida para fundos claros, negative para fundos escuros).

#### C. Para Gráficas e Impressos (Folders, Panfletos, Cartões de Visita):
*   **Importante:** Os arquivos na pasta [`1. Web-SVG/`](file:///d:/Projetos%20Lovable/Esol%20Energy/esolenergy/brand-kit/1. Web-SVG) são vetores matemáticos puros. Eles podem ser importados diretamente para o **Illustrator, Photoshop, CorelDraw ou Canva Pro** e exportados em PDF de alta qualidade para impressão.
